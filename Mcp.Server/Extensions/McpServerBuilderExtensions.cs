...
public static class McpServerBuilderExtensions
{
    ...
    private static async ValueTask<GetPromptResult> HandleGetPromptRequestsAsync(RequestContext<GetPromptRequestParams> context, CancellationToken cancellationToken)
    {
        ...
        PromptDefinition? definition = promptDefinitions.FirstOrDefault(d => d.Prompt.Name == promptName) ?? throw new ArgumentException($"No handler found for the prompt '{promptName}'.");
